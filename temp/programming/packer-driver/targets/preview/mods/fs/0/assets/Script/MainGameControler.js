    ...
    execute: function () {
      ...
      _export("MainGameControler", MainGameControler = (_dec = ccclass('MainGameControler'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(CCString), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function MainGameControler() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "gameArea", _descriptor, _assertThisInitialized(_this));
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "bulletForce", _descriptor5, _assertThisInitialized(_this));

          return _this;
        }

        var _proto = MainGameControler.prototype;
        ...
        _proto.isInGameArea = function isInGameArea(pos) {
          var szBg = this.gameArea.getComponent(UITransform).contentSize;
        ...
        return MainGameControler;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "gameArea", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
