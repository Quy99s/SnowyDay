  ...
  return {
    ...
    execute: function () {
      ...
      _export("Joystick", Joystick = (_dec = ccclass('Joystick'), _dec2 = property({
        ...
        tooltip: "半径"
      }), _dec(_class = (_class2 = (_temp = class Joystick extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "joystickType", _descriptor3, this);

          _initializerDefineProperty(this, "directionType", _descriptor4, this);

          _initializerDefineProperty(this, "_stickPos", _descriptor5, this);

          _initializerDefineProperty(this, "_touchLocation", _descriptor6, this);
        ...
        _touchStartEvent(event) {
          ...
          if (this.joystickType === JoystickType.FIXED) {
            ...
            const moveVec = touchPos.subtract(this.ring.getPosition()); // 触摸点与圆圈中心的距离

            const distance = moveVec.length(); // 手指在圆圈内触摸,控杆跟随触摸点
        ...
        _touchMoveEvent(event) {
          ...
          const location = event.getUILocation();
          const touchPos = new Vec3(location.x, location.y); // move vector
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "dot", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
